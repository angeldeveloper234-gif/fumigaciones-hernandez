      ...
      <article className="bg-white">
        ...
        <header className="relative w-full aspect-[21/9] max-h-[28rem] bg-slate-900">
          ...
          <div className="absolute inset-x-0 bottom-0">
            <div className="container pb-[2rem]">
              <span className="inline-block bg-[#19D42B] text-white text-[0.6875rem] font-black uppercase tracking-widest px-[0.75rem] py-[0.375rem] mb-4">
                {post.category}
              </span>
        ...
        <div className="container py-[3rem] md:py-[4rem]">
          ...
          <nav aria-label="Ruta de navegación" className="mb-[2rem] text-[0.8125rem] font-bold uppercase tracking-wide text-gray-500">
            <Link href="/" className="hover:text-[#19D42B]">Inicio</Link>
            <span className="mx-2">/</span>
            <Link href="/blog" className="hover:text-[#19D42B]">Blog</Link>
          </nav>

          <div className="max-w-[46rem]">
            <p className="text-[1.125rem] md:text-[1.25rem] text-[#212121] font-bold leading-relaxed mb-[2rem]">
              {post.summary}
            </p>
            ...
            <div className="mt-[3rem] border border-slate-200 bg-slate-50 p-[1.5rem] md:p-[2rem] flex flex-col sm:flex-row items-center justify-between gap-4">
              <div>
                <h2 className="text-[1.25rem] font-black uppercase tracking-tight text-[#212121]">
              ...
              <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto">
                <a
                  href={SITE.phoneHref}
                  className="inline-flex items-center justify-center gap-2 bg-[#FBC02D] hover:bg-[#D6A200] text-white font-black text-[0.8125rem] px-5 py-3 uppercase tracking-wide transition-colors"
                >
                  <Phone className="size-4" /> Llamar
                </a>
                <Link
                  href="/#appointment"
                  className="inline-flex items-center justify-center gap-2 bg-[#19D42B] hover:bg-[#13AA23] text-white font-black text-[0.8125rem] px-5 py-3 uppercase tracking-wide transition-colors"
                >
            ...
            <div className="mt-[2.5rem]">
              <Link
                href="/blog"
                className="inline-flex items-center gap-2 text-[#212121] font-bold text-[0.8125rem] uppercase hover:text-[#19D42B] transition-colors"
              >
          ...
          {related.length > 0 && (
            <div className="mt-[4rem] pt-[3rem] border-t border-slate-200">
              <h2 className="text-[1.5rem] font-black uppercase tracking-tight text-[#212121] mb-[1.5rem]">
                Artículos relacionados
              </h2>
                ...
                {related.map((r) => (
                  ...
                  >
                    ...
                    <div className="p-[1rem]">
                      <h3 className="text-[1rem] font-black uppercase tracking-tight text-[#212121] group-hover:text-[#19D42B] transition-colors leading-[1.25] line-clamp-2">
                        {r.title}
                      </h3>
                    </div>
                  </Link>
