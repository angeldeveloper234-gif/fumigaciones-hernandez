...
export async function generateMetadata({
  ...
  return generatePageMetadata({
    ...
    keywords: [
      ...
      `${service.name.toLowerCase()} Quintana Roo`,
      ...
      <article className="bg-white">
        <header className="relative isolate overflow-hidden bg-[#102414] text-white">
          ...
          <div className="container py-12 md:py-16">
            ...
            >
              ...
              <ArrowRight className="size-3" />
              <span className="text-[#78ED84]">{service.name}</span>
            </nav>
            ...
            <div className="mt-9 grid gap-10 lg:grid-cols-[1.08fr_0.92fr] lg:items-center lg:gap-16">
              <div>
                ...
                <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                  ...
                  <Link
                    href="/servicios"
                    className="inline-flex min-h-13 items-center justify-center gap-2 rounded-full border border-white/28 px-7 text-sm font-black text-white transition hover:border-white/60 hover:bg-white/8 focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#FBC02D]"
                  >
              ...
              <div className="relative min-h-[22rem] overflow-hidden rounded-[2rem] border border-white/12 bg-white/5 shadow-2xl md:min-h-[30rem]">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-[#102414]/78 via-transparent to-transparent" />
                <div className="absolute bottom-5 left-5 right-5 rounded-2xl border border-white/12 bg-[#102414]/82 p-4 backdrop-blur-sm">
                  <p className="text-xs font-black uppercase tracking-[0.13em] text-[#78ED84]">
                    Fumcon del Sureste
                  </p>
                  <p className="mt-1 text-sm font-bold text-white/78">
                    Yucatán · Quintana Roo · Atención 24/7
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="container py-18 md:py-24">
          <div className="grid gap-12 lg:grid-cols-[minmax(0,1fr)_22rem] lg:gap-16">
            ...
            <aside className="self-start rounded-[1.75rem] border border-black/8 bg-[#F4F8F4] p-6 shadow-[0_16px_40px_rgba(16,36,20,0.07)] lg:sticky lg:top-28">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-7 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-full bg-[#102414] px-5 text-sm font-black text-white transition hover:bg-[#183C20] focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-[#19D42B]"
              >
              ...
              {service.methods.map((method, index) => (
                ...
                >
                  <div className="flex items-start justify-between gap-5">
                    <span className="flex size-12 items-center justify-center rounded-2xl bg-[#19D42B] text-lg font-black text-[#102414]">
                      {index + 1}
                    </span>
                    <span className="rounded-full border border-[#FBC02D]/35 bg-[#FBC02D]/10 px-3 py-1 text-[0.65rem] font-black uppercase tracking-[0.12em] text-[#FBC02D]">
                      Método Fumcon
                    </span>
                  </div>
              ...
              {processSteps.map((step, index) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm font-black text-[#19D42B]">
                      0{index + 1}
                    </span>
                  </div>
        ...
        <section className="bg-[#F4F8F4] py-18 md:py-24">
          <div className="container grid gap-6 lg:grid-cols-2">
            <div className="rounded-[1.75rem] border border-black/8 bg-white p-6 md:p-8">
              ...
              <ul className="mt-6 space-y-4">
                {service.recommendations.map((recommendation) => (
                  ...
                  >
                    <Check className="mt-1 size-4 shrink-0 text-[#118F1D]" />
            ...
            <div className="rounded-[1.75rem] bg-[#FBC02D] p-6 text-[#212121] md:p-8">
              ...
              <ul className="mt-6 grid gap-3 sm:grid-cols-2">
                {service.includes.map((item) => (
                  ...
                  >
                    <CheckCircle2 className="size-5 shrink-0 text-[#118F1D]" />
                    {item}
                  </li>
                ))}
              </ul>
            ...
            <div className="mt-9 grid gap-5 md:grid-cols-3">
              {related.map((item) => (
                <Link
                  ...
                  className="group overflow-hidden rounded-[1.5rem] border border-black/8 bg-[#F7F9F7] transition hover:-translate-y-1 hover:border-[#19D42B]/60 hover:shadow-[0_18px_42px_rgba(16,36,20,0.1)] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-[#19D42B]"
                >
                  ...
                  <div className="p-5">
                    <h3 className="text-xl font-black text-[#212121] transition group-hover:text-[#118F1D]">
                      {item.name}
                    </h3>
        ...
        <section className="bg-[#102414] py-16 text-white">
          <div className="container flex flex-col gap-7 lg:flex-row lg:items-center lg:justify-between">
            <div>
              <p className="text-xs font-black uppercase tracking-[0.16em] text-[#78ED84]">
              ...
              <p className="mt-3 text-sm leading-6 text-white/65">
                Atendemos hogares y negocios en Yucatán y Quintana Roo, las 24
                horas.
              </p>
            </div>
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex min-h-13 shrink-0 items-center justify-center gap-2 rounded-full bg-[#19D42B] px-7 text-sm font-black text-[#102414] transition hover:-translate-y-0.5 hover:bg-[#29E43A] focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-white"
            >
              <MessageCircle className="size-5" />
